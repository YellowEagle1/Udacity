...
contract StarNotary is ERC721 {
    ...
    string public constant name = "StarNotaryV2";
	string public constant symbol = "SN2";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
		...
		require(token1Owner == msg.sender || token2Owner == msg.sender, "You can't exchange the Star you don't owned");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
		...
		require(_to1 != ownerOf(_tokenId), "You can't transfer the Star to the same account");
